          ...
          <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left space-y-8">
            ...
            >
              <span className="bg-gradient-to-r from-zinc-950 via-zinc-800 to-zinc-600 dark:from-white dark:via-neutral-100 dark:to-neutral-400 bg-clip-text text-transparent font-medium">
                We convert offline businesses into brands
              </span>
            </motion.h1>
            ...
            >
              At <strong>Growwfy</strong>, we believe your digital presence
              shouldn't look like a generic template. The engineers at{" "}
              <strong>Growwfy Digital Marketing</strong> craft premium,
              custom-engineered digital brands designed to load in a blink,
              dominate organic search, and convert casual visitors into lifetime
              clients.
            </motion.p>
            ...
            >
              <div>
                <div className="font-sans text-2xl font-bold text-zinc-900 dark:text-white sm:text-3xl">
                  &lt; 0.4s
                </div>
