      ...
      <div className="relative z-10 mx-auto flex w-fit rounded-full bg-neutral-900 border border-gray-700 p-1">
        <button
          ...
          className={cn(
            ...
            selected === "0" ? "text-white animate-pulse" : "text-gray-200",
          )}
        >
          {selected === "0" && (
            <motion.span
        ...
        <button
          ...
          className={cn(
            ...
            selected === "1" ? "text-white animate-pulse" : "text-gray-200",
          )}
        >
          {selected === "1" && (
            <motion.span
...
export default function PricingSection6() {
  ...
  return (
    ...
    >
      ...
      <div className="grid md:grid-cols-3 max-w-5xl gap-4 py-6 px-4 mx-auto relative z-40">
          ...
          >
            ...
            >
              ...
              <CardContent className="pt-0 flex-grow flex flex-col justify-between">
                <div>
                  <button
                    className={`w-full mb-6 p-4 text-xl rounded-xl cursor-pointer font-semibold transition-all hover:scale-[1.02] ${
                      plan.popular
                        ? "bg-gradient-to-t from-blue-500 to-blue-600 shadow-lg shadow-blue-800/50 border border-blue-500 text-white"
                        : plan.buttonVariant === "outline"
                          ? "bg-gradient-to-t from-neutral-950 to-neutral-600 shadow-lg shadow-neutral-900 border border-neutral-800 text-white hover:border-neutral-700"
